...
public class LibraryMain {
    ...
    public static void main(String[] args) {
        ...
        library.add(new Video("Harry Potter and the Sorcerer's Stone", "Chris Columbus", 2));
        library.add(new Video("Mac Weekly", "Mr. Nobody", 5));
        library.add(new Video("Can't come up with a name", "Adam Yao", 1));
