package D0925_graphicsPractice;
...
public class Emojis {
    ...
    public static GraphicsGroup createSmileyFace(double size) {
        ...
        // create eyes
        // 2020.3.18: Super BIG eyes
        Ellipse leftEye = creatEye(size * 0.5, size * 0.5);
        Ellipse rightEye = creatEye(size * 0.5, size * 0.5);
        leftEye.setCenter(size * 0.25, size * 0.3);
        rightEye.setCenter(size * 0.75, size * 0.3);
        group.add(leftEye);
        group.add(rightEye);
     ...
     * to (width,height).
     */
    private static Ellipse createHead(double width, double height) {
    ...
    private static Ellipse creatEye(double width, double height) {
