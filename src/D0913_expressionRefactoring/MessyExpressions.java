package D0913_expressionRefactoring;

@SuppressWarnings("ALL")
public class MessyExpressions {

    /**
     * Activity for refactoring practice.
     *
...
//            .isBlank();
        ...
        String replacedAText = upperCaseText.replace("A", " ");
        String replacedExclText = replacedAText.replace("!", " ");

        return replacedExclText.isBlank();
    }
...
//                text.length()));
        ...
        // 1. String lengthStr = String.valueOf(length);
        // 2. String lengthStr = Integer.toString(length);
        // 3. String lenth = "" + length;
        String lengthStr = "" + length;
        return text.contains(lengthStr);
